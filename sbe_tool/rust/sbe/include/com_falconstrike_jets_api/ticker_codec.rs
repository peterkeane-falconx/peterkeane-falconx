...
pub use encoder::TickerEncoder;
pub use decoder::TickerDecoder;
...
pub mod encoder {
    ...
    impl<'a> TickerEncoder<'a> {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn funding_rate_encoder(self) -> decimal_codec::DecimalEncoder<Self> {
...
pub mod decoder {
    ...
    impl<'a> ActingVersion for TickerDecoder<'a> {
        #[inline]
    ...
    impl<'a> TickerDecoder<'a> {
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn funding_rate_decoder(self) -> decimal_codec::DecimalDecoder<Self> {
            let offset = self.offset + 21;
