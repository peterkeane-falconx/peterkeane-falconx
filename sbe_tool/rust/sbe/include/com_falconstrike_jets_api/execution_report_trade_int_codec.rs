...
pub use encoder::ExecutionReportTradeIntEncoder;
pub use decoder::ExecutionReportTradeIntDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 203;
pub const SBE_TEMPLATE_ID: u16 = 2010;
...
pub mod encoder {
    ...
    pub struct ExecutionReportTradeIntEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionReportTradeIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionReportTradeIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionReportTradeIntEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ExecutionReportTradeIntDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionReportTradeIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionReportTradeIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionReportTradeIntDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionReportTradeIntDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
