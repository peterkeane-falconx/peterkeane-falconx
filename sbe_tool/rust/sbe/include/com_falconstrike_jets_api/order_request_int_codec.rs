...
pub use encoder::OrderRequestIntEncoder;
pub use decoder::OrderRequestIntDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 127;
pub const SBE_TEMPLATE_ID: u16 = 2002;
...
pub mod encoder {
    ...
    pub struct OrderRequestIntEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for OrderRequestIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for OrderRequestIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> OrderRequestIntEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct OrderRequestIntDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for OrderRequestIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for OrderRequestIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for OrderRequestIntDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> OrderRequestIntDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
