...
pub use encoder::ExecutionReportPendingUpdateExtEncoder;
pub use decoder::ExecutionReportPendingUpdateExtDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 236;
pub const SBE_TEMPLATE_ID: u16 = 2011;
...
pub mod encoder {
    ...
    pub struct ExecutionReportPendingUpdateExtEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionReportPendingUpdateExtEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionReportPendingUpdateExtEncoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionReportPendingUpdateExtEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ExecutionReportPendingUpdateExtDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionReportPendingUpdateExtDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionReportPendingUpdateExtDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionReportPendingUpdateExtDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionReportPendingUpdateExtDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
