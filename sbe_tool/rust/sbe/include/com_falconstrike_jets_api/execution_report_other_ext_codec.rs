...
pub use encoder::ExecutionReportOtherExtEncoder;
pub use decoder::ExecutionReportOtherExtDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 196;
pub const SBE_TEMPLATE_ID: u16 = 2017;
...
pub mod encoder {
    ...
    pub struct ExecutionReportOtherExtEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionReportOtherExtEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionReportOtherExtEncoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionReportOtherExtEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ExecutionReportOtherExtDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionReportOtherExtDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionReportOtherExtDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionReportOtherExtDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionReportOtherExtDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn exec_type(&self) -> exec_type::ExecType {
            self.get_buf().get_u8_at(self.offset + 187).into()
        }

        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn exec_id(&self) -> i64 {
            self.get_buf().get_i64_at(self.offset + 188)
        }
