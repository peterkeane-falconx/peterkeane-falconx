...
pub use encoder::ExecutionReportRejectedExtEncoder;
pub use decoder::ExecutionReportRejectedExtDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 177;
pub const SBE_TEMPLATE_ID: u16 = 2019;
...
pub mod encoder {
    ...
    pub struct ExecutionReportRejectedExtEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionReportRejectedExtEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionReportRejectedExtEncoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionReportRejectedExtEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn reject_reason(&mut self, value: reject_reason::RejectReason) {
...
pub mod decoder {
    ...
    pub struct ExecutionReportRejectedExtDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionReportRejectedExtDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionReportRejectedExtDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionReportRejectedExtDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionReportRejectedExtDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// REQUIRED enum
        #[inline]
        pub fn reject_reason(&self) -> reject_reason::RejectReason {
            self.get_buf().get_u8_at(self.offset + 168).into()
        }

        /// primitive field - 'REQUIRED'
        #[inline]
        pub fn exec_id(&self) -> i64 {
            self.get_buf().get_i64_at(self.offset + 169)
        }
