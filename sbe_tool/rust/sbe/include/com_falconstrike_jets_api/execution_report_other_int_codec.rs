...
pub use encoder::ExecutionReportOtherIntEncoder;
pub use decoder::ExecutionReportOtherIntDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 186;
pub const SBE_TEMPLATE_ID: u16 = 2018;
...
pub mod encoder {
    ...
    pub struct ExecutionReportOtherIntEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionReportOtherIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionReportOtherIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionReportOtherIntEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ExecutionReportOtherIntDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionReportOtherIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionReportOtherIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionReportOtherIntDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionReportOtherIntDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn exec_type(&self) -> exec_type::ExecType {
            self.get_buf().get_u8_at(self.offset + 185).into()
        }
