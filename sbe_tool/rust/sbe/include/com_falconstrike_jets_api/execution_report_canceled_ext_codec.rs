...
pub use encoder::ExecutionReportCanceledExtEncoder;
pub use decoder::ExecutionReportCanceledExtDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 236;
pub const SBE_TEMPLATE_ID: u16 = 2013;
...
pub mod encoder {
    ...
    pub struct ExecutionReportCanceledExtEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionReportCanceledExtEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionReportCanceledExtEncoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionReportCanceledExtEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ExecutionReportCanceledExtDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionReportCanceledExtDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionReportCanceledExtDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionReportCanceledExtDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionReportCanceledExtDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
