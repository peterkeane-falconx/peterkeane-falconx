...
pub use encoder::ExecutionReportCanceledIntEncoder;
pub use decoder::ExecutionReportCanceledIntDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 194;
pub const SBE_TEMPLATE_ID: u16 = 2014;
...
pub mod encoder {
    ...
    pub struct ExecutionReportCanceledIntEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionReportCanceledIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionReportCanceledIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionReportCanceledIntEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ExecutionReportCanceledIntDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionReportCanceledIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionReportCanceledIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionReportCanceledIntDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionReportCanceledIntDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
