...
pub use encoder::ExecutionReportReplacedIntEncoder;
pub use decoder::ExecutionReportReplacedIntDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 194;
pub const SBE_TEMPLATE_ID: u16 = 2016;
...
pub mod encoder {
    ...
    pub struct ExecutionReportReplacedIntEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionReportReplacedIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionReportReplacedIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionReportReplacedIntEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ExecutionReportReplacedIntDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionReportReplacedIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionReportReplacedIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionReportReplacedIntDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionReportReplacedIntDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
