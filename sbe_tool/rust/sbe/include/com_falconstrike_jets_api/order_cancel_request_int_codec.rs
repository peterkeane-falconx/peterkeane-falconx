...
pub use encoder::OrderCancelRequestIntEncoder;
pub use decoder::OrderCancelRequestIntDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 32;
pub const SBE_TEMPLATE_ID: u16 = 2004;
...
pub mod encoder {
    ...
    pub struct OrderCancelRequestIntEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for OrderCancelRequestIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for OrderCancelRequestIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> OrderCancelRequestIntEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct OrderCancelRequestIntDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for OrderCancelRequestIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for OrderCancelRequestIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for OrderCancelRequestIntDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> OrderCancelRequestIntDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
