...
pub use encoder::ExecutionReportPendingUpdateIntEncoder;
pub use decoder::ExecutionReportPendingUpdateIntDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 194;
pub const SBE_TEMPLATE_ID: u16 = 2012;
...
pub mod encoder {
    ...
    pub struct ExecutionReportPendingUpdateIntEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionReportPendingUpdateIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionReportPendingUpdateIntEncoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionReportPendingUpdateIntEncoder<'a> {
...
pub mod decoder {
    ...
    pub struct ExecutionReportPendingUpdateIntDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionReportPendingUpdateIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionReportPendingUpdateIntDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionReportPendingUpdateIntDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionReportPendingUpdateIntDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        pub fn exec_type(&self) -> exec_type::ExecType {
            self.get_buf().get_u8_at(self.offset + 193).into()
        }
