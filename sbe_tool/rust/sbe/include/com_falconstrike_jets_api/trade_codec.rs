...
pub mod encoder {
    ...
    impl<'a> TradeEncoder<'a> {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn volume_quantity_encoder(self) -> decimal_codec::DecimalEncoder<Self> {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn volume_notional_encoder(self) -> decimal_codec::DecimalEncoder<Self> {
...
pub mod decoder {
    ...
    impl<'a> TradeDecoder<'a> {
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn volume_quantity_decoder(self) -> decimal_codec::DecimalDecoder<Self> {
            let offset = self.offset + 43;
            decimal_codec::DecimalDecoder::default().wrap(self, offset)
        }
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn volume_notional_decoder(self) -> decimal_codec::DecimalDecoder<Self> {
            let offset = self.offset + 52;
            decimal_codec::DecimalDecoder::default().wrap(self, offset)
        }
