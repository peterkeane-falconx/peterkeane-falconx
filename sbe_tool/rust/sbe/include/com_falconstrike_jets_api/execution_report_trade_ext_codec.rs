...
pub use encoder::ExecutionReportTradeExtEncoder;
pub use decoder::ExecutionReportTradeExtDecoder;

pub const SBE_BLOCK_LENGTH: u16 = 213;
pub const SBE_TEMPLATE_ID: u16 = 2009;
...
pub mod encoder {
    ...
    pub struct ExecutionReportTradeExtEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for ExecutionReportTradeExtEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for ExecutionReportTradeExtEncoder<'a> {
        #[inline]
    ...
    impl<'a> ExecutionReportTradeExtEncoder<'a> {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn last_px_encoder(self) -> decimal_codec::DecimalEncoder<Self> {
        ...
        /// COMPOSITE ENCODER
        #[inline]
        pub fn last_qty_encoder(self) -> decimal_codec::DecimalEncoder<Self> {
...
pub mod decoder {
    ...
    pub struct ExecutionReportTradeExtDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> ActingVersion for ExecutionReportTradeExtDecoder<'a> {
        #[inline]
    ...
    impl<'a> Reader<'a> for ExecutionReportTradeExtDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for ExecutionReportTradeExtDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> ExecutionReportTradeExtDecoder<'a> {
        pub fn wrap(
            mut self,
            buf: ReadBuf<'a>,
            offset: usize,
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn last_px_decoder(self) -> decimal_codec::DecimalDecoder<Self> {
            let offset = self.offset + 50;
        ...
        /// COMPOSITE DECODER
        #[inline]
        pub fn last_qty_decoder(self) -> decimal_codec::DecimalDecoder<Self> {
            let offset = self.offset + 59;
            decimal_codec::DecimalDecoder::default().wrap(self, offset)
        }
        ...
        pub fn exec_id(&self) -> i64 {
            self.get_buf().get_i64_at(self.offset + 205)
        }
